...
import { loopAllChildren, isInclude, getOffset, filterParentPosition, handleCheckState, getCheck, getStrictlyValue } from './util';
...
class Tree extends React.Component {
  ...
  getDefaultExpandedKeys(props, willReceiveProps) {
    let expandedKeys = willReceiveProps ? undefined : this.getFilterExpandedKeys(props, 'defaultExpandedKeys', props.defaultExpandAll);
  ...
  render() {
    ...
    if (props.checkable && (this.checkedKeysChange || props.loadData)) {
      if (props.checkStrictly) {
        ...
        let checkKeys;
        if (!props.loadData && this.checkKeys && this._checkedKeys && this._checkedKeys.every((i, index) => checkedKeys[index] === i)) {
